...
- **Migration (staged, not applied):** [`20260702000001_price_versioning_append_only.sql`](../supabase/migrations/20260702000001_price_versioning_append_only.sql).
...
- **Not run:** `supabase db push`, `git push` (per AGENTS.md). Migration awaits Andy's apply.
