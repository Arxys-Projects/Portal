...
| File | Status |
|---|---|
| [`calculator-math-phase-2-plan.md`](./calculator-math-phase-2-plan.md) | **Active** — the sizing-engine rework, in three phases against the golden harness. Authority for what gets built; backed by [`audits/calculator-math-audit.md`](./audits/calculator-math-audit.md). **Phase A (D1–D8) built 2026-08-12, golden diff approved, columns applied by hand** ([apply note](./apply-notes/0123-calculator-math-phase-a.md), ADRs [0123](./decisions/0123-bitrate-reanchor-and-sublinear-fps.md)–[0128](./decisions/0128-audio-metadata-counted.md)). **Phase B** (D9, per-group retention) and **Phase C** (D10, VSR rating basis + profile-copy consolidation) are open and must land separately, or the golden diff stops being attributable. |
